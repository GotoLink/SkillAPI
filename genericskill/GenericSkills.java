...
public class GenericSkills {
	...
	public static final String[] skills = 
		{"Creeper Blast","Levitate","Summon Wolf","Super Jump","Healing Breeze","Binding Signet","Unrelenting Force","Barrage"};
	...
	public void load(FMLInitializationEvent event) {
	    ...
	    GameRegistry.addShapelessRecipe(new ItemStack(genSkillBook), 
	    		new Object[] {Item.ingotGold,Item.book});
		...
		GameRegistry.addRecipe(new ItemStack(heritageAmulet), new Object[] {" S ", "S S", "GDG" , 
		...
		GameRegistry.addShapelessRecipe(new ItemStack(manaPotion), 
				new Object[] {Item.glassBottle, new ItemStack(Item.dyePowder, 1, 4)});

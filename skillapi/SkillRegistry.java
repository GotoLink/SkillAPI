...
public class SkillRegistry {
	 ...
	 * Registers a skill.
	 * @param skill
	 * @return false if a skill with the same name (case sensitive)
	 * has already been registered. Returns true if skill was successfully registered.
	 */
	...
	/**
	 * 
	 * @param name of the skill to get the registered instance from, case sensitive
	 ...
	 * @param skill to teach to the player
	 * @return true if the player learned the skill successfully.
	 * false if the skill does not exist, the player already knows it
	 * or the player isn't qualified to learn it. 
	 */
	...
	/**
	 * Triggers any skill currently in the skill bar. Can be used anywhere (e.g. Item right-click)
	 * @param player 
	 * @param skillName
	 ...
	 * @param name
	 * @param player 
	 * @return true if a skill is active. Only skills with a duration can be active.
	 */
